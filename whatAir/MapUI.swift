...
class MapUI: UIViewController, MAMapViewDelegate ,AMapLocationManagerDelegate{
    ...
    override func viewDidLoad() {
        ...
        locationManager.requestLocation(withReGeocode: false, completionBlock: { [weak self] (location: CLLocation?, reGeocode: AMapLocationReGeocode?, error: Error?) in
            ...
            if let location = location {
                ...
                selfLatitude_Double = location.coordinate.latitude
                selfLongitude_Double = location.coordinate.longitude
